...
## The script reads the power consumption data into R, and plots a scatterplot of power use
## by energy sub-meter over a two-day span in February 2007
...
plot3 <- function(directory) {
        ...
        plot(data$Time,data$Sub_metering_1,type="n",ylab="Energy sub metering", xlab="") # Empty plot
        points(data$Time, data$Sub_metering_1, col="black", type="l")   # Plot one sub-meter at a time 
